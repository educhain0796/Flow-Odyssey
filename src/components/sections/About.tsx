      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="about-content grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Educhain is the blockchain designed for the next generation of apps, games, and digital assets. 
              Our platform leverages Educhain's unique features to provide a seamless content sharing experience.
            </motion.p>
            <motion.ul 
              className="space-y-4"
              initial={{ opacity: 0, y: 20 }}
